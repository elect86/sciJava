 ...
 * @see [DependencyHandler.add]
 */
fun DependencyHandler.testRuntimeOnly(dependencyNotation: String,
 ...
 * @see [DependencyHandler.add]
 */
fun DependencyHandler.testRuntimeOnly(group: String,
                                      name: String,
                                      version: String? = null,
        ...
        addExternalModuleDependencyTo(this, "testRuntimeOnly", group, name, version, configuration, classifier, ext, dependencyConfiguration)
 ...
 * @see [DependencyHandler.add]
 */
fun <T : ModuleDependency> DependencyHandler.testRuntimeOnly(dependency: T,
 ...
 * @see [ArtifactHandler.add]
 */
fun ArtifactHandler.testRuntimeOnly(artifactNotation: Any,
